function startCircle2Script() {

const container = document.querySelector('.extern-2');
const input = document.querySelector('.circular-input-2');
const RotatingCircle = document.getElementById('rotating-circle-2');
const output = document.querySelector('#circle-output-2');
...
RotatingCircle.style.stroke = "#CA0A0A"
