...
2) In the folder, you will find "MDPSaver" (a shortcut file). It is leading to "run.cmd" which simply does the command for you.
-> About the command: $./python main.py 
--> You can move the shortcut on your desktop and you will never have to care about the folder again.
